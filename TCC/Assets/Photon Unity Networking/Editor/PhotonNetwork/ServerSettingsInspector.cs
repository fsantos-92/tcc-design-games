...
public class ServerSettingsInspector : Editor
{
    ...
    {
        this.hasVoice = System.Type.GetType("ExitGames.Client.Photon.Voice.VoiceClient, Assembly-CSharp") != null || System.Type.GetType("ExitGames.Client.Photon.Voice.VoiceClient, Assembly-CSharp-firstpass") != null;
        this.hasChat = System.Type.GetType("ExitGames.Client.Photon.Chat.ChatClient, Assembly-CSharp") != null || System.Type.GetType("ExitGames.Client.Photon.Chat.ChatClient, Assembly-CSharp-firstpass") != null;
    }
